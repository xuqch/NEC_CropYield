...
print("Syear: %s" % Syear)
print("Eyear: %s" % Eyear)
fname = os.path.join('/stu01/xuqch3/finished/data/PCSE/', "output/sensitivity/default/")
...
if __name__ == '__main__':
    ...
    for ssp in ssps:
        ...
        Start_time = xr.open_dataset(f'{path}/PCSE/pr_t/pr_t_Growthday_%s.nc' % (ssp)).start
        ...
        dk.to_netcdf('%s/soybean_output_%s_%s_pr.nc' % (fname, ssp, runname), engine='netcdf4')
