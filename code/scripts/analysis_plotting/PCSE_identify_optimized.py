...
if __name__ == '__main__':
    ...
    Yieldstd = []
    # Apr 15-->105
    ll = xr.open_dataset(f'{path}/rice_output_ssp585_sowing_Max_Yield_default.nc')
    ...
    rice_sowing_Max_Yield = xr.open_dataset(f'{path}/rice_output_ssp585_sowing_Max_Yield_final.nc')["TAGP"].where(
        crop > -1) / default_ssp585_rice * 100.0
    maize_sowing_Max_Yield = xr.open_dataset(f'{path}/maize_output_ssp585_sowing_Max_Yield_final.nc')["TAGP"].where(
        crop > -1) / default_ssp585_maize * 100.0
    soybean_sowing_Max_Yield = xr.open_dataset(f'{path}/soybean_output_ssp585_sowing_Max_Yield_final.nc')["TAGP"].where(
