...
if __name__ == '__main__':
    ...
    for scenario in scenarios:
        ...
        #     ax.set_yticks(np.arange(500, 1200,100), np.arange(500, 1200,100))
        #     ax.set_yticklabels(np.arange(500, 1200,100))
        #     ax.tick_params(axis='both', top='off', labelsize=16)
        #     ax.legend(loc='best', shadow=False, fontsize=12)
        #     #ax.set_title('%s_%s' % (name,fnames[i]))
        #     plt.tight_layout()
        #     plt.savefig(f'{Figout}/precipitation_year.eps', format='eps', dpi=600)  # timeseries_lines
        #     plt.show()
