        ...
        for ilat in enumerate(ds.lat.values):
            ...
            if da.tasmax.values[0] > -9999.0:
                ...
                for i, inputs in enumerate(all_runs):
                    ...
                    sited = WOFOST72SiteDataProvider(WAV=10, CO2=dco2[0].values, SMLIM=0.35)
...
if __name__ == '__main__':
    ...
    for ssp in ssps:
        ...
        dk.to_netcdf('%s/rice_output_%s_%s.nc' % (fname, Eyear, ssp), engine='netcdf4')
